...
template <typename T, typename... Args>  // prints minimum from variable number of arguments 
...
bool isMatch(string str1, string str2) // checks if the strings match using  a matching factor
{
